 ...
 * @author Ryan Park
 */
public class SevenCogs extends UpgradeProcess {
    ...
    protected JournalArticle addJournalArticleContent(
            long userId, long groupId, String title, String content,
            ServiceContext serviceContext)
            throws Exception {

        return addJournalArticleContent(
                userId, groupId, title, content, StringPool.BLANK,
                StringPool.BLANK, serviceContext);
    }
    ...
    protected JournalArticle addJournalArticle(
        ...
        return addJournalArticleContent(userId, groupId, title, content, structureId, templateId, serviceContext);
    }
    ...
    protected Layout addLayout(
        ...
        return addLayout(group, name, privateLayout, friendlyURL, layouteTemplateId, LayoutConstants.DEFAULT_PARENT_LAYOUT_ID);
    }

    protected Layout addLayout(
            Group group, String name, boolean privateLayout, String friendlyURL,
            String layouteTemplateId, long parentLayoutId)
            throws Exception {
        ...
        Layout layout = LayoutLocalServiceUtil.addLayout(
				...
				parentLayoutId, name, StringPool.BLANK,
    ...
    protected String addPortletId(
        ...
        return addPortletId(layout, portletId, columnId, -1);
    }

	protected String addPortletId(
			Layout layout, String portletId, String columnId, int columnPos)
			throws Exception {

		LayoutTypePortlet layoutTypePortlet =
				(LayoutTypePortlet)layout.getLayoutType();
		portletId = layoutTypePortlet.addPortletId(
				0, portletId, columnId, columnPos, false);
    ...
    protected void configureJournalContent(
        ...
        configureJournalContent(layout, portletId, articleId, String.valueOf(layout.getGroupId()));
    }

	protected void configureJournalContent(
			Layout layout, String portletId, String articleId, String groupId)
			throws Exception {
		...
		portletSetup.setValue("groupId", groupId);
